...
<html lang="en">
    <head>
        ...
        <title>ADVOCATE - INSTALLATION</title>
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class=" col-md-9">
                                                <input id="username" type="text" value="" name="username" class="form-control" placeholder="Your Username" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="password" class="col-md-3">Token</label>
                                            <div class=" col-md-9">
                                                <input id="token" type="text" value="" name="site_update_token" class="form-control" placeholder="Enter random value" />
                                            </div>
                                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed ADVOCATE</span>  
                                </div>
