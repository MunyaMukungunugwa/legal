...
# Database: adv_cln
# Generation Time: 2021-08-12 07:08:14 +0000
# ************************************************************
...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2022 at 12:30 PM
...
CREATE TABLE `account` (
  ...
  `bank_holder_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `contact_number` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `bank_address` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
# Dump of table account_transfer
# ------------------------------------------------------------
...
CREATE TABLE `account_transfer` (
  ...
  `reference_no` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `actions` (`id`, `name`, `parent_id`, `always_allowed`, `alias`, `is_hidden`)
VALUES
...
INSERT INTO `acts` (`id`, `title`, `description`)
VALUES
  (1,'Corporate Law','Income Tax'),
  (2,'Traffic Law',''),
  (3,'Conveyancing And Property',''),
  (4,'Construction Law',' '),
  (5,'Mining Law',''),
  (6,'Alternative Dispute Resolution ','Mediation, Arbitration, Conciliation'),
  (7,'Family Law','Decree Bona Defuncti '),
  (8,'Banking Law','Facilities, Bonds, Indemnities, Undertakings, Comfort letters,  Escrow Agreements, Securitisation'),
  (9,'Insurance Law',''),
  (10,'Maritime& Shipping Law','');
...
# Dump of table acts_sub_sections
# ------------------------------------------------------------

DROP TABLE IF EXISTS `acts_sub_sections`;
...
CREATE TABLE `appointments` (
  ...
  `motive` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `attendance` (
  ...
  `mark_in_notes` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mark_out_notes` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mark_in_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `mark_out_ip` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `bank_details` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `account_holder_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `bank_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ifsc` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `pan` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `case_categories` (
  ...
  `display_in_menu` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'NO',
...
INSERT INTO `case_categories` (`id`, `name`, `parent_id`, `display_in_menu`, `description`, `slug`)
VALUES
  (1,'Cross Vesting case',15,'NO',NULL,NULL),
  (2,'Garnishee Proceeding ',0,'NO',NULL,NULL),
  (3,'Transferred Case',17,'NO',NULL,NULL),
  (4,'Part heard Case',18,'NO',NULL,NULL),
  (5,'Bill of Costs',23,'NO',NULL,NULL),
  (6,'Cause (Originating)',20,'NO',NULL,NULL),
  (7,'Interpleader Proceeding',0,'NO',NULL,'interpleader-proceeding'),
  (8,'Action (Summons)',20,'YES','<p>ok</p>','action-summons'),
  (9,'Matter',23,'NO',NULL,NULL);

/*!40000 ALTER TABLE `case_categories` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table case_stages
# ------------------------------------------------------------
...
INSERT INTO `case_stages` (`id`, `name`)
VALUES
  (1,'Injunctions'),
  (2,'Interrogation '),
...
CREATE TABLE `case_study` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `case_categories` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `notes` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cases` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `case_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `client_id` int(10) unsigned NOT NULL,
  `location_id` int(10) unsigned NOT NULL,
  `court_id` int(10) unsigned NOT NULL,
  `court_category_id` int(10) unsigned NOT NULL,
  `case_category_id` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `case_stage_id` int(10) unsigned NOT NULL,
  `act_id` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `start_date` date NOT NULL,
  `hearing_date` date NOT NULL,
  `o_lawyer` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
# Dump of table cases_sub_sections
# ------------------------------------------------------------

DROP TABLE IF EXISTS `cases_sub_sections`;
...
INSERT INTO `countries` (`id`, `code`, `name`, `currency`, `Phone`)
VALUES
...
# Dump of table court_categories
# ------------------------------------------------------------
...
CREATE TABLE `emails` (
  ...
  `phone_number` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `expense` (
  ...
  `bill_number` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `expense_product` (
  ...
  `product_item` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `fees` (
  ...
  `ref_no` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `invoice` (
  ...
  `due_date` date NOT NULL,
  `invoice_no` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `category_id` int(10) unsigned NOT NULL,
  `ref_no` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tax_id` int(10) unsigned NOT NULL,
  `sub_total` float DEFAULT '0',
  `discount` float DEFAULT '0',
...
CREATE TABLE `invoice_product` (
  ...
  `product_id` int(10) unsigned NOT NULL,
  `product_item` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `quantity` float DEFAULT '0',
  `price` float DEFAULT '0',
  `tax_value` float DEFAULT '0',
  `discount` float DEFAULT '0',
...
CREATE TABLE `language` (
  ...
  `direction` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `flag` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `file` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `language_code` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
...
INSERT INTO `language` (`id`, `name`, `direction`, `flag`, `file`, `language_code`)
VALUES
...
# Dump of table notification_setting
# ------------------------------------------------------------
...
CREATE TABLE `product_service` (
  ...
  `type` enum('product','service') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
# Dump of table rel_case_study_attachments
# ------------------------------------------------------------
...
# Dump of table rel_department_designation
# ------------------------------------------------------------
...
# Dump of table rel_document_files
# ------------------------------------------------------------
...
# Dump of table rel_document_files_shared
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rel_document_files_shared`;
...
# Dump of table rel_form_custom_fields
# ------------------------------------------------------------
...
CREATE TABLE `settings` (
  ...
  `date_format` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `timezone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `smtp_host` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `smtp_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `smtp_pass` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `smtp_port` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `home_first_slide` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_slide_second` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_third_slide` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `footer_text_heading` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_footer_text` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `site_facebook_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_twitter_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_google_plus_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_linkedin_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_pininterest_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `site_instagram_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `update_info` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `site_update_token` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `disable_right_click` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `disable_print_screen` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `disable_copy_paste_click` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `header_logo_height` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `custom_css` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `header_javascript` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `footer_javascript` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `cookies_content_display` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `cookies_content` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `cookies_content_btn_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `footer_last_row_left_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `footer_last_row_right_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `display_content_on_home_page` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `home_first_slide_text` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `home_first_slide_button_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_first_slide_button_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `home_second_slide_text` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `home_second_slide_button_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_second_slide_button_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_third_slide_text` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `home_third_slide_button_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_third_slide_button_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `states` (
  ...
  PRIMARY KEY (`id`),
  KEY `code` (`code`(191)),
  KEY `nameAscii` (`name`(20)),
  FULLTEXT KEY `SEARCH_ADMIN_1_CODESASCIIS` (`code`,`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3955 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

LOCK TABLES `states` WRITE;
/*!40000 ALTER TABLE `states` DISABLE KEYS */;

INSERT INTO `states` (`id`, `code`, `name`, `country_code`)
VALUES
...
CREATE TABLE `tax` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `percent` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tax` (`id`, `name`, `percent`)
VALUES
  (1,'VAT','15'),
  (2,'GST','10'),
  (3,'CGT40','40'),
...
INSERT INTO `user_role` (`id`, `slug`, `name`, `description`)
VALUES
...
CREATE TABLE `users` (
  ...
  `sector` varchar(255) COLLATE utf8_unicode_ci  NULL,
  `registration_number` varchar(255) COLLATE utf8_unicode_ci  NULL,
  `uif_number` varchar(255) COLLATE utf8_unicode_ci  NULL,
  ...
  `joining_salary` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
...
-- INSERT INTO `users` (`id`,`employee_id`, `name`, `image`, `username`, `password`, `gender`, `dob`, `email`, `contact`, `address`, `user_role`, `token`, `client_case_alert`, `department_id`, `designation_id`, `joining_date`, `joining_salary`, `status`, `message_status`) VALUES
-- (1,0, 'install_admin_first_name', 'user-default.jpg', 'install_users_username', 'install_users_password', '', '2018-08-07', 'install_admin_email_address', '', '', 1, 'expired', 1, 0, 0, 'install_admin_joining_date', '', 1, 1);
